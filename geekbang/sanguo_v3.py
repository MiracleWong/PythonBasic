...
def find_main_charecters(charecter_name):
    with open('/Users/miraclewong/github/PythonBasic/geekbang/txt/sanguo.txt', encoding='gb18030') as f:
        data = f.read().replace("\n", "")
...
name_dict = {}
with open('/Users/miraclewong/github/PythonBasic/geekbang/txt/name.txt', encoding='utf-8') as f:
    for line in f:
        names = line.split('|')
        for n in names:
...
weapon_dict = {}
with open('/Users/miraclewong/github/PythonBasic/geekbang/txt/weapon.txt', encoding='utf-8') as f:
        i = 1
        for line in f:
             if i%2 == 1:
